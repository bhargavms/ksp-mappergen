...
package com.bhargavms.mappergen.code.generator.utils

import com.bhargavms.mappergen.code.generator.error.UndefinedClass
...
private fun KSName.typeName(): ClassName? {
    ...
    return ClassName(getQualifier(), shortNames.first(), *(shortNames.drop(1).toTypedArray()))
}

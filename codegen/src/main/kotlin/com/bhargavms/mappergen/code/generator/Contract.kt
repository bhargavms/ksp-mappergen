...
internal class MapperFile(
    ...
    override fun isIterable(type: KSType): Boolean =
        resolver.builtIns.iterableType.isAssignableFrom(type)

    override fun isArray(type: KSType) =
        resolver.builtIns.arrayType.isAssignableFrom(type)
}
